...
def _read_from_stream(
    ...
    for _idx, frame in enumerate(container.decode(**stream_name)):
        # print("frame {} start {} end {}".format(frame, start_offset, end_offset))
    ...
    # print("name{} startoffset {} end offset {}".format(stream_name, start_offset, end_offset))
...
def read_video(
    ...
    try:
        with av.open(filename, metadata_errors="ignore") as container:
            ...
            # print("size of video streams {}, size of audio streams {}".format(
            #     len(container.streams.video),len(container.streams.audio)))
    except av.AVError:
...
def _can_read_timestamps_from_packets(container: "av.container.Container") -> bool:
    ...
    extradata = container.streams[0].codec_context.extradata
        # print(f"successfully loaded extra data {container.streams[0].codec_context} of {container.streams[0]}")
    # except:
        # print(f"cannot load extra data of {container.streams[0]}")
        # extradata = None
        # extradata = container.streams[0].codec_context.extradata
...
def read_video_timestamps(filename: str, pts_unit: str = "pts") -> Tuple[List[int], Optional[float]]:
    ...
    return pts, video_fps, video_time_base
